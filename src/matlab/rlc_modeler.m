node = readmatrix("../../impedance/PAB2G_IND_RX_IMPEDANCE_RIVER_ROTATOR_8020.CSV");
node = node(1:201,:);
...
[rlc,resnorm,residuals,exitflag,output] = lsqcurvefit(@rlc_model,rlc0,f,ydata,[0 0 1e-9 0],[]);
